...
public class EasySSLSocketFactory implements SocketFactory,
	...
	private static final String TAG = EasySSLSocketFactory.class.getName();
	...
	private SSLContext getSSLContext() throws IOException {
		Log.i(TAG, "getSSLContext");
		if (this.sslcontext == null) {
			this.sslcontext = createEasySSLContext();
		}
		Log.d(TAG, sslcontext.toString());
	...
	public Socket createSocket(Socket socket, String host, int port,
		...
		Log.i(TAG,"createSocket: " +  host + ":" + port);
